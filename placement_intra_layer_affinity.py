...
def clusters_for_all_layers(affinity_matrix_all_layers, num_clusters, result_path=None):
    ...
    for layer_id in range(num_layers):
        ...
        for expert_id, group_id in enumerate(labels):
            layer_clusters[int(group_id)].append(int(expert_id))  #group_id -> list of experts_id
...
if __name__ == "__main__":
    ...
    fig_dir = f"cluster_result/spectral/figs"
    os.makedirs(fig_dir, exist_ok=True)
    result_path = f"cluster_result/spectral/clusters_result_all_layers.json"
